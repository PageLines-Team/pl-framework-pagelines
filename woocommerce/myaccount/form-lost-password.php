...
<form method="post" class="lost_reset_password">
	...
	<?php if( 'lost_password' == $args['form'] ) : ?>
		...
		<?php echo apply_filters( 'woocommerce_lost_password_message', __( '<br /><h2 class="pl-sans">Lost your password?</h2> <p>Please enter your username or email address. You will receive a link to create a new password via email.</p>', 'woocommerce' ) ); ?>
