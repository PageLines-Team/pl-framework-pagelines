...
class PLShowcaseFeaturedGrid extends PageLinesSection {
	...
	function section_opts(){
			...
			$opts = array(
				...
				// 	'title'		=> 'Configure Showcase Posts',
				// 	'label'		=>	'<i class="icon icon-retweet"></i> Edit Showcase Posts',
				// 	'help'		=> "Showcase posts are configured using global settings in WP admin.",
